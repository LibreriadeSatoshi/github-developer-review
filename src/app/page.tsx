      ...
      <main className="flex flex-col items-center gap-8 px-6">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="max-w-sm text-zinc-600 dark:text-zinc-400">
            Evaluate Bitcoin open-source contributors for grant funding.
          </p>
        </div>
        <form
          action={async () => {
        ...
        >
          <button
            type="submit"
            className="flex h-12 items-center gap-2 rounded-full bg-zinc-900 px-6 text-white transition-colors hover:bg-zinc-700 dark:bg-zinc-100 dark:text-black dark:hover:bg-zinc-300"
          >
            <svg
              role="img"
              aria-hidden="true"
